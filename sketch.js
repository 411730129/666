...
function preload() {
  bgImg = loadImage('picture/background.jpg');

  player1Images.idle = loadImage('picture/10.png');
  player1Images.walkLeft = loadImage('picture/12.png');
  player1Images.walkRight = loadImage('picture/11.png');
  player1Images.jump = loadImage('picture/13.png');

  player2Images.idle = loadImage('picture/22.png');
  player2Images.walkLeft = loadImage('picture/22.png');
  player2Images.walkRight = loadImage('picture/20.png');
  player2Images.jump = loadImage('picture/23.png');

  bulletImage = loadImage('picture/zidan.png');
  bulletImageLeft = loadImage('picture/zidan1.png');
}
